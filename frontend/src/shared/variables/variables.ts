...
interface Networks {
  [key: string]: {
    chainId: string
    elTokenAddress: string
    currency: string
    decimalsToken: number
    decimalsElToken: number
    name: string
    partUrl: string
...
export const networks: Networks = {
  '0xaa36a7': {
    chainId: '0xaa36a7',
    elTokenAddress: import.meta.env.VITE_ELTOKEN_ADDRESS_SEPOLIA,
    currency: 'SepoliaETH',
    decimalsElToken: import.meta.env.VITE_ELTOKEN_DECIMALS_SEPOLIA,
    decimalsToken: import.meta.env.VITE_ERC20_DECIMALS_SEPOLIA,
    name: 'Sepolia',
    partUrl: '',
  ...
  '0xe708': {
    chainId: '0xe708',
    elTokenAddress: import.meta.env.VITE_ELTOKEN_ADDRESS_MAINNET,
    currency: 'ETH',
    decimalsElToken: import.meta.env.VITE_ELTOKEN_DECIMALS_LINEA_MAINNET,
    decimalsToken: import.meta.env.VITE_ERC20_DECIMALS_LINEA_MAINNET,
    name: 'Linea Mainnet',
    partUrl: 'linea.',
